<x-app-layout>
    ...
    <script>
        const routeImprimir = (otId) => `{{ url('wms/ordenes-trabajo') }}/${otId}/imprimir`;
                        ...
                        cont.insertAdjacentHTML('beforeend', `
                            <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                                <div class="flex justify-between items-start mb-1">
                                    ...
                                    <a href="${routeImprimir(ot.id)}" target="_blank" class="text-xs font-semibold text-blue-600 bg-blue-50 rounded-full px-3 py-1 flex items-center gap-1">
                                            🖨️ Imprimir OT
                                    </a>
                                </div>
                                ${palletsHtml}
