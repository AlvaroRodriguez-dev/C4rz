    ...
    <script>
        ...
        function renderResultado(data) {
            ...
            data.filas.forEach(f => {
                ...
                cont.append(`
                    <div class="bg-white border border-gray-200 rounded-xl p-3 shadow-sm ${esSaldoInicial ? 'border-dashed' : ''} ${esAjuste ? 'border-orange-200' : ''}">
                        <div class="flex justify-between items-start gap-2">
                            ...
                            <div class="text-right shrink-0">
                                ${f.entrada ? `<p class="text-sm font-semibold text-green-600">+${f.entrada}</p>` : ''}
                                ${f.salida ? `<p class="text-sm font-semibold text-red-600">-${f.salida}</p>` : ''}
