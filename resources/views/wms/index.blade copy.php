        ...
        <div class="max-w-5xl mx-auto px-3">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <a href="{{ route('wms.ingresos.ajuste.create') }}"
                    ...
                    <div class="flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" fill="none" viewBox="0 0 24 24"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12h6M12 9v6M9 3h6l4 4v13a1 1 0 01-1 1H6a1 1 0 01-1-1V4a1 1 0 011-1h3z" />
                ...
                <a href="{{ route('wms.ordenes.trabajo.index') }}"
                    class="bg-amber-500 hover:bg-amber-600 rounded-2xl shadow text-white p-6 transition">
                    ...
                    <div class="flex justify-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" fill="none" viewBox="0 0 24 24"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4M7 3h7l5 5v13a1 1 0 01-1 1H7a2 2 0 01-2-2V5a2 2 0 012-2z" />
