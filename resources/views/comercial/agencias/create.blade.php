<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Nueva Agencia</h2>
    </x-slot>

    <div class="py-6 sm:py-8 max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
        <form action="{{ route('comercial.agencias.store') }}" method="POST" class="bg-white shadow rounded-lg p-4 sm:p-6 space-y-4">
            @csrf
            ...
            <div>
                ...
                <textarea name="direccion" rows="2"
                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">{{ old('direccion') }}</textarea>
            ...
            <div>
                ...
                <input type="url" name="url_maps" value="{{ old('url_maps') }}" placeholder="https://maps.app.goo.gl/..."
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
            ...
            <div class="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 pt-2">
                ...
                <button type="submit" class="px-4 py-2 bg-red-700 hover:bg-red-800 text-white rounded-lg">Guardar</button>
            </div>
        </form>
    </div>
</x-app-layout>